...
<body>
  <h3>Cher(e) {{$user->name}}, </h3>
   ...
   <p>
    ...
    Nous sommes impatients de travailler ensemble pour faire croître notre entreprise et atteindre nos objectifs communs. N’hésitez pas à nous contacter si vous avez des questions ou si vous souhaitez discuter davantage de notre partenariat.
    
  </p> 
    Cordialement, TANDIS-INVEST
</body>
</html>